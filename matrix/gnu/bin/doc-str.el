;; -*-byte-compile-dynamic-docstring: new; -*-

;; name project: guile-int
;; name program: int
;; func program: documentation string and compilation
;; gnu hack: GNU Guile Documentation (String and Compilation Reference Manual)
;; emacs: loading ...
;; byte-compile: warning syntax code
;; documentation: string
;; dynamically: compile
;; features: plots graphic
;; memory: intel 4.0 gib

;; start file
;; stream roku series new films
